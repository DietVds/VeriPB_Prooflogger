...
template void VeriPbProofLogger::delete_constraint<std::vector<VeriPB::Lit>, VeriPB::Var>(const std::vector<VeriPB::Lit> &lits, const wght RHS, const substitution<VeriPB::Var>& witness);
...
template void VeriPbProofLogger::delete_constraint<std::vector<VeriPB::Lit>, std::vector<wght>, VeriPB::Var>(const std::vector<VeriPB::Lit> &lits, const std::vector<wght> &weights, const wght RHS, const substitution<VeriPB::Var>& witness);
...
template void VeriPbProofLogger::delete_constraint<std::vector<uint32_t>, uint32_t>(const std::vector<uint32_t> &lits, const wght RHS, const substitution<uint32_t>& witness);
...
template void VeriPbProofLogger::delete_constraint<std::vector<uint32_t>, std::vector<wght>, uint32_t>(const std::vector<uint32_t> &lits, const std::vector<wght> &weights, const wght RHS, const substitution<uint32_t>& witness);
...
template void VeriPbProofLogger::delete_constraint<std::vector<int>, int>(const std::vector<int> &lits, const wght RHS, const substitution<int>& witness);
...
template void VeriPbProofLogger::delete_constraint<std::vector<int>, std::vector<wght>, int>(const std::vector<int> &lits, const std::vector<wght> &weights, const wght RHS, const substitution<int>& witness);
