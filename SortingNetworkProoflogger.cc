...
template constraintid SortingNetworkProoflogger::derive_counting_definition_of_outputvars_right<Glucose::vec<Glucose::Lit>, std::vector<constraintid>>(Glucose::vec<Glucose::Lit>& inputlits, Glucose::vec<Glucose::Lit>& outputlits, wght j, constraintid output_geq_input, std::vector<constraintid>& sortedness_outputlits);
template constraintid SortingNetworkProoflogger::derive_counting_definition_of_outputvars_left<Glucose::vec<Glucose::Lit>, std::vector<constraintid>>(Glucose::vec<Glucose::Lit>& inputlits, Glucose::vec<Glucose::Lit>& outputlits, wght j, constraintid output_geq_input, std::vector<constraintid>& sortedness_outputlits);
