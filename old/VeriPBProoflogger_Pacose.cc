...
template constraintid VeriPbProofLogger::derive_if_implied<std::vector<VeriPB::Lit>>(const constraintid hint, const std::vector<VeriPB::Lit> &lits, const wght RHS = 1);
...
template constraintid VeriPbProofLogger::derive_if_implied<std::vector<VeriPB::Lit>, std::vector<wght>>(const constraintid hint, const std::vector<VeriPB::Lit>& lits_greater, const std::vector<wght>& weights_greater, const wght const_greater, const std::vector<VeriPB::Lit>& lits_smaller, const std::vector<wght>& weights_smaller, const wght const_smaller  );    
template constraintid VeriPbProofLogger::derive_if_implied<std::vector<VeriPB::Lit>>(const std::vector<VeriPB::Lit> &lits, const wght RHS = 1);
template constraintid VeriPbProofLogger::derive_if_implied<std::vector<VeriPB::Lit>, std::vector<wght>>(const std::vector<VeriPB::Lit> &lits, const std::vector<wght> &weights, const wght RHS);
template constraintid VeriPbProofLogger::derive_if_implied<std::vector<VeriPB::Lit>, std::vector<wght>>(const std::vector<VeriPB::Lit>& lits_greater, const std::vector<wght>& weights_greater, const wght const_greater, const std::vector<VeriPB::Lit>& lits_smaller, const std::vector<wght>& weights_smaller, const wght const_smaller  );  
...
template std::string VeriPbProofLogger::literal_to_string<uint32_t>(const uint32_t &lit);
...
template void VeriPbProofLogger::store_variable_name<uint32_t>(const uint32_t &var, const std::string &name);
...
template constraintid VeriPbProofLogger::derive_if_implied<std::vector<uint32_t>>(const constraintid hint, const std::vector<uint32_t> &lits, const wght RHS = 1);
template constraintid VeriPbProofLogger::derive_if_implied<std::vector<uint32_t>, std::vector<uint64_t>>(const constraintid hint, const std::vector<uint32_t> &lits, const std::vector<uint64_t> &weights, const wght RHS);
template constraintid VeriPbProofLogger::derive_if_implied<std::vector<uint32_t>, std::vector<uint64_t>>(const constraintid hint, const std::vector<uint32_t>& lits_greater, const std::vector<uint64_t>& weights_greater, const wght const_greater, const std::vector<uint32_t>& lits_smaller, const std::vector<uint64_t>& weights_smaller, const wght const_smaller  );    
template constraintid VeriPbProofLogger::derive_if_implied<std::vector<uint32_t>>(const std::vector<uint32_t> &lits, const wght RHS = 1);
template constraintid VeriPbProofLogger::derive_if_implied<std::vector<uint32_t>, std::vector<uint64_t>>(const std::vector<uint32_t> &lits, const std::vector<uint64_t> &weights, const wght RHS);
template constraintid VeriPbProofLogger::derive_if_implied<std::vector<uint32_t>, std::vector<uint64_t>>(const std::vector<uint32_t>& lits_greater, const std::vector<uint64_t>& weights_greater, const wght const_greater, const std::vector<uint32_t>& lits_smaller, const std::vector<uint64_t>& weights_smaller, const wght const_smaller  );  
...
template constraintid VeriPbProofLogger::redundance_based_strengthening_unit_clause<uint32_t>(const uint32_t& lit);
...
template std::string VeriPbProofLogger::literal_to_string<int>(const int &lit);
...
template void VeriPbProofLogger::store_variable_name<int>(const int &var, const std::string &name);
...
template constraintid VeriPbProofLogger::derive_if_implied<std::vector<int>>(const constraintid hint, const std::vector<int> &lits, const wght RHS = 1);
template constraintid VeriPbProofLogger::derive_if_implied<std::vector<int>, std::vector<uint64_t>>(const constraintid hint, const std::vector<int> &lits, const std::vector<uint64_t> &weights, const wght RHS);
template constraintid VeriPbProofLogger::derive_if_implied<std::vector<int>, std::vector<uint64_t>>(const constraintid hint, const std::vector<int>& lits_greater, const std::vector<uint64_t>& weights_greater, const wght const_greater, const std::vector<int>& lits_smaller, const std::vector<uint64_t>& weights_smaller, const wght const_smaller  );    
template constraintid VeriPbProofLogger::derive_if_implied<std::vector<int>>(const std::vector<int> &lits, const wght RHS = 1);
template constraintid VeriPbProofLogger::derive_if_implied<std::vector<int>, std::vector<uint64_t>>(const std::vector<int> &lits, const std::vector<uint64_t> &weights, const wght RHS);
template constraintid VeriPbProofLogger::derive_if_implied<std::vector<int>, std::vector<uint64_t>>(const std::vector<int>& lits_greater, const std::vector<uint64_t>& weights_greater, const wght const_greater, const std::vector<int>& lits_smaller, const std::vector<uint64_t>& weights_smaller, const wght const_smaller  );
...
template constraintid VeriPbProofLogger::redundance_based_strengthening_unit_clause<int>(const int& lit);
