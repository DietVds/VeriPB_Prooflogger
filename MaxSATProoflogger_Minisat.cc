...
template constraintid MaxSATProoflogger::add_unit_clause_blocking_literal<VeriPB::Lit>(VeriPB::Lit var, constraintid cxn_id, VeriPB::Lit unitclause, wght weight_softclause, bool rewrite_objective = false);
template constraintid MaxSATProoflogger::add_unit_clause_blocking_literal<Minisat::Lit>(Minisat::Lit var, constraintid cxn_id, Minisat::Lit unitclause, wght weight_softclause, bool rewrite_objective = false);
