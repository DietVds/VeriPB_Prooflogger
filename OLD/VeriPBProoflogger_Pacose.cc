...
template void VeriPbProofLogger::CP_lit_axiom<uint32_t>(const CPDerRef& cp_id, const uint32_t& lit, const wght& n=1);
template CPDerRef VeriPbProofLogger::start_CPDer_from_lit_axiom<uint32_t>(const uint32_t& lit, const wght& n=1);
template void VeriPbProofLogger::CP_add_lit_axiom<uint32_t>(const CPDerRef& cp_id, const uint32_t& lit, const wght& n=1);
template void VeriPbProofLogger::CP_weaken<uint32_t>(const CPDerRef& cp_id, const uint32_t& var);
template void VeriPbProofLogger::CP_weaken<uint32_t>(const CPDerRef& cp_id, const uint32_t& l, const wght& n);
template constraintid VeriPbProofLogger::prove_by_contradiction<std::vector<uint32_t>, std::vector<wght>>(std::vector<uint32_t>& lits, std::vector<wght>& weights, wght RHS, std::vector<CPDerRef> cpder);
...
template void VeriPbProofLogger::CP_lit_axiom<int>(const CPDerRef& cp_id, const int& lit, const wght& n=1);
template CPDerRef VeriPbProofLogger::start_CPDer_from_lit_axiom<int>(const int& lit, const wght& n=1);
template void VeriPbProofLogger::CP_add_lit_axiom<int>(const CPDerRef& cp_id, const int& lit, const wght& n=1);
template void VeriPbProofLogger::CP_weaken<int>(const CPDerRef& cp_id, const int& var);
template void VeriPbProofLogger::CP_weaken<int>(const CPDerRef& cp_id, const int& l, const wght& n);
template constraintid VeriPbProofLogger::prove_by_contradiction<std::vector<int>, std::vector<wght>>(std::vector<int>& lits, std::vector<wght>& weights, wght RHS, std::vector<CPDerRef> cpder);
