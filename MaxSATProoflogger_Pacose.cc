...
template constraintid MaxSATProoflogger::add_unit_clause_blocking_literal<VeriPB::Lit>(VeriPB::Lit var, constraintid cxn_id, VeriPB::Lit unitclause, wght weight_softclause, bool bidir_reif, bool rewrite_objective, bool write_objective_update);
...
template constraintid MaxSATProoflogger::add_unit_clause_blocking_literal<uint32_t>(uint32_t var, constraintid cxn_id, uint32_t unitclause, wght weight_softclause, bool bidir_reif, bool rewrite_objective, bool write_objective_update);
...
template constraintid MaxSATProoflogger::add_unit_clause_blocking_literal<int>(int var, constraintid cxn_id, int unitclause, wght weight_softclause, bool bidir_reif, bool rewrite_objective, bool write_objective_update);
